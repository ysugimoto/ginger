...
var Assets = assets.NewFileSystem(map[string][]string{"/events": []string{"alb.json", "cloudwatch.json", "apigateway.json", "s3.json", "sqs.json", "default.json", "kinesis.json"}, "/": []string{"ale", "main.go.template"}}, map[string]*assets.File{
	"/ale": &assets.File{
		Path:     "/ale",
		FileMode: 0x1a4,
