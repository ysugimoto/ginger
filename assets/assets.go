...
var Assets = assets.NewFileSystem(map[string][]string{"/": []string{"ale", "main.go.template"}, "/events": []string{"cloudwatch.json", "apigateway.json", "s3.json", "sqs.json", "default.json", "kinesis.json"}}, map[string]*assets.File{
	"/events/s3.json": &assets.File{
		Path:     "/events/s3.json",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1544182378, 1544182378550658382),
		Data:     []byte(_Assets4518a7bcadf80bb83fed670406e243eb329230b9),
	}, "/events/sqs.json": &assets.File{
		Path:     "/events/sqs.json",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1544182509, 1544182509761023330),
		Data:     []byte(_Assetsbcc7ff0fb173f4d7324a5d571efda92a9339a0d1),
	}, "/events/kinesis.json": &assets.File{
		Path:     "/events/kinesis.json",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1544182603, 1544182603904869166),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1544182739, 1544182739264617549),
