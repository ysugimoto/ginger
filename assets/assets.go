...
var _functionTomlTemplate = []byte("")

func functionTomlTemplateBytes() ([]byte, error) {
	return bindataRead(
		_functionTomlTemplate,
		"Function.toml.template",
	)
}

func functionTomlTemplate() (*asset, error) {
	bytes, err := functionTomlTemplateBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "Function.toml.template", size: 54, mode: os.FileMode(420), modTime: time.Unix(1518934586, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"Function.toml.template": functionTomlTemplate,
	"ale": ale,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"Function.toml.template": &bintree{functionTomlTemplate, map[string]*bintree{}},
