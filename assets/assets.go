...
var Assets = assets.NewFileSystem(map[string][]string{"/events": []string{"cloudwatch.json", "apigateway.json", "s3.json", "sqs.json", "default.json", "kinesis.json"}, "/": []string{"ale", "main.go.template"}}, map[string]*assets.File{
	"/main.go.template": &assets.File{
		...
		Path:     "/events",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1544425862, 1544425862821639529),
		Data:     nil,
